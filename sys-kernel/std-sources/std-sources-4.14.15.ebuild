...
# When updating ebuild, Make sure your kernel config follows
# the following steps if you copied/pasted the config from the
# sysresccd vm:
# 1. Remove text in CONFIG_INITRAMFS_SOURCE
# 2. Set CONFIG_LOCALVERSION to the value in $TAIL

# For System Rescue CD 5.2.0 (Standard Kernel - x86_64)
TAIL="std520-amd64"
